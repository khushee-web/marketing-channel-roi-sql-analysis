...
## Dataset
Marketing Campaign Performance dataset (Kaggle), containing ~300,000 campaign records across Instagram, Twitter, Facebook, and Pinterest, with fields for acquisition cost, ROI, conversion rate, clicks, impressions, campaign goal, and more.
...
|---|---|---|---|---|
| Instagram | 75,101 | $7,726 | 4.01 | ~$2.33B |
| Twitter | 74,653 | $7,774 | 4.00 | ~$2.32B |
| Facebook | 75,164 | $7,745 | 3.99 | ~$2.32B |
| Pinterest | 75,082 | $7,770 | **0.72** | **~$418M** |

- **Pinterest underperforms every other channel by ~5.5x on ROI**, despite receiving a nearly identical number of campaigns and acquisition cost.
